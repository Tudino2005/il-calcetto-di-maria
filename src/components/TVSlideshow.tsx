        ...
        <div className="w-full h-full flex flex-col justify-center animate-fade-in-up">
                        ...
                        {topPlayers.map((tp: any, idx: number) => (
                          <div key={tp.id} className={idx > 0 ? "pt-3 border-t border-slate-700/50" : ""}>
                            <div className="flex items-center gap-3 flex-1 justify-between pr-6">
                              ...
                              if (r === 'portiere' || r === 'difensore') return <img src="/images/defender_icon_gold.png" alt="Defender" className="h-[84px] w-[144px] object-contain drop-shadow-md" />;
          ...
          {currentSlide.type === "player_stats" && (() => {
            ...
            const renderRoleBadge = (role: string) => {
              ...
              if (r === 'portiere' || r === 'difensore') return <img src="/images/defender_icon_gold.png" alt="Defender" className="h-[96px] w-[168px] object-contain drop-shadow-md" />;
